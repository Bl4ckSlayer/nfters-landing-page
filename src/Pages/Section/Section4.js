...
const Section4 = () => {
  ...
  return (
    <div className="bg-slate-100 py-20  mb-8 ">
      {" "}
      <div className="container  grid w-5/6 mb-16 mx-auto ">
        {" "}
        <h1 className="text-5xl  font-bold ">Collection Featured NFTs</h1>
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-3 container mx-auto  gap-10 lg:gap-0 md:gap-0  ">
